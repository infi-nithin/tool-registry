"""Migration utilities for programmatic migration control.

This module provides utility functions for running and managing database migrations
programmatically from within the application. It wraps Alembic functionality
with async support.

Example:
    >>> from db.migrations import run_migrations, get_current_revision
    >>> 
